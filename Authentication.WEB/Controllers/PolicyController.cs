        ...
        public async Task<JObject> GetExistentLoggedInUserData()
        {
            ...
            if (System.Web.HttpContext.Current.User.Identity.IsAuthenticated)
            {
                ...
                if (loggedUserData == null)
                {
                    ...
                    insuredData.Add("DateBirth", loggedUser.DateOfBirth.Value.Year + String.Format("-{0:00}-{0:00}", +loggedUser.DateOfBirth.Value.Month, loggedUser.DateOfBirth.Value.Day));
