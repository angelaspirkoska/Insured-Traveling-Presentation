...
namespace Authentication.WEB.Services
{
    class ZohoMailService
    {
        ...
        public ZohoMailService(string receiver, string sender = "policies@insuredtraveling.com", string mailServer = "smtp.zoho.com", int port = 587, string passphrase = "Enter4Sy")
        {
