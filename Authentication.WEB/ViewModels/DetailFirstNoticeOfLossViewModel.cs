...
namespace InsuredTraveling.ViewModels
{
    public class DetailFirstNoticeOfLossViewModel
    {
        ...
        public int Claimant_BankID { get; set; }
        public string Claimant_BankAccount { get; set; }
        public int PolicyHolder_BankID { get; set; }
        public string PolicyHolder_BankAccount { get; set; }
